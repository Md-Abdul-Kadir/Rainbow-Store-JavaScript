...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h4 class="text-success">Average rating : ${product.rating.rate}</h4>
      <h4 class="text-warning">${product.rating.count} <span class="text-dark">people rated here</span></h4>
...
const showDetails = (info) => {
  ...
  const div = document.createElement('div');
  div.innerHTML = `<div class="card mb-3 shadow-lg">
  ...
  document.getElementById("details_div").appendChild(div);
